          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-6 sm:p-8 lg:p-12 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row items-start mb-8">
                  {!logoError ? (
                    <Image 
                      ...
                      className="w-24 h-24 sm:w-32 sm:h-32 md:w-48 md:h-48 object-contain sm:mr-6 mb-4 sm:mb-0"
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      <div className="flex items-center">
                        <div className="w-7 h-7 sm:w-8 sm:h-8 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center mr-3">
                          <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white" />
                        </div>
                        <span className="text-white/90 font-medium text-xs sm:text-sm">Comprehensive Registration & Validation</span>
                  </div>
                      <div className="flex items-center">
                        <div className="w-7 h-7 sm:w-8 sm:h-8 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center mr-3">
                      <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white" />
                    </div>
                        <span className="text-white/90 font-medium text-xs sm:text-sm">Advanced Performance Analytics</span>
                  </div>
                      <div className="flex items-center">
                        <div className="w-7 h-7 sm:w-8 sm:h-8 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center mr-3">
                      <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white" />
                        </div>
                        <span className="text-white/90 font-medium text-xs sm:text-sm">Seamless Event Management</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* Main Headline */}
                <div className="mb-8">
                  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 leading-tight">We Are The Best In<br/>Athlete Management</h2>
            ...
            <div className="p-6 sm:p-8 lg:p-12">
              ...
              <div className={`${getFormContainerClass()} backdrop-blur-xl rounded-3xl p-6 sm:p-8 border shadow-2xl`}>
                {/* Form Header */}
                <div className="text-center mb-8">
                  ...
                  <p className={`${getRoleTextClass()} text-base sm:text-lg`}>{selectedRoleLabel.toUpperCase()} MEMBER</p>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-20 h-20 rounded-full overflow-hidden bg-white/10 border border-white/20 flex items-center justify-center">
                    {imagePreview ? (
                      <Image src={imagePreview} alt="Profile preview" width={80} height={80} className="w-full h-full object-cover" />
                    ) : (
